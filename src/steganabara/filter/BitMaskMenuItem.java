...
public class BitMaskMenuItem extends JMenuItem implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		BitMaskOptions[] optionsList = BitMaskDialog.showBitMaskDialog(imageContainer.getComponent(),
				"Bit Mask Filter");
		if (optionsList != null) {
			for (BitMaskOptions options : optionsList) {
				showBitMaskDialog(imageContainer.getComponent(), image, options);
			}
		}
